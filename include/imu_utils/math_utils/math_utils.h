...
orientaionOfVectors( const Eigen::Vector3d v,
                     const double theta)
{
    return Eigen::Quaterniond( cos(0.5 * theta),
                               sin(0.5 * theta) * v(0),
                               sin(0.5 * theta) * v(1),
                               sin(0.5 * theta) * v(2) );
}
...
/// \return   :q_12
inline Eigen::Quaterniond
orientaionOfVectors( const Eigen::Vector3d v1,
