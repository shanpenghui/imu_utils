...
bool
Polynomial::FindRoots( const double y,
                       const eigen_utils::Vector& polynomial_in,
                       eigen_utils::Vector& real,
                       eigen_utils::Vector& imaginary )
{
...
void
Polynomial::FindLinearPolynomialRoots( const eigen_utils::Vector& polynomial,
                                       eigen_utils::Vector& real,
